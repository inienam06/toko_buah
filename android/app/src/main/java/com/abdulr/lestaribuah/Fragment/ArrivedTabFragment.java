...
import com.abdulr.lestaribuah.Adapter.OrderStatusArrivedAdapter;
...
public class ArrivedTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_arrived_tab, container, false);
    ...
    private void getData() {
        api.getOrderStatusArrived(this);
    }
    ...
    public void putData(JSONArray data) {
        OrderStatusArrivedAdapter adapter = new OrderStatusArrivedAdapter(this, data);

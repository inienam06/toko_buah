...
public class OrderStatusWaitingAdapter extends RecyclerView.Adapter<OrderStatusWaitingAdapter.Holder> {
    private WaitingTabFragment fragment;
    private JSONArray data;

    public OrderStatusWaitingAdapter(WaitingTabFragment fragment, JSONArray data) {
    ...
    @NonNull
    @Override
    public OrderStatusWaitingAdapter.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(fragment.getActivity()).inflate(R.layout.content_order_waiting, viewGroup,false);

        return new OrderStatusWaitingAdapter.Holder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderStatusWaitingAdapter.Holder holder, int i) {
        try {

...
public class HomeTerpopulerAdapter extends RecyclerView.Adapter<HomeTerpopulerAdapter.Holder> {
    private HomeFragment fragment;
    private JSONArray data;

    public HomeTerpopulerAdapter(HomeFragment fragment, JSONArray data) {
    ...
    @NonNull
    @Override
    public HomeTerpopulerAdapter.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(fragment.getActivity()).inflate(R.layout.content_main_terpopuler, viewGroup,false);

        return new HomeTerpopulerAdapter.Holder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeTerpopulerAdapter.Holder holder, int i) {
        try {

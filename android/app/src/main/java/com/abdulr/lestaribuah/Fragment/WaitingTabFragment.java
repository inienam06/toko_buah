...
import com.abdulr.lestaribuah.Adapter.OrderStatusWaitingAdapter;
...
public class WaitingTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_waiting_tab, container, false);
    ...
    private void getData() {
        api.getOrderStatusWaiting(this);
    }
    ...
    public void putData(JSONArray data) {
        OrderStatusWaitingAdapter adapter = new OrderStatusWaitingAdapter(this, data);
